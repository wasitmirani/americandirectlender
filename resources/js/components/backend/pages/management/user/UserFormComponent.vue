                      ...
                      <div class="row">
                        ...
                        <div class="col-md-5">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="Company" v-model="user.company">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                          <div class="mb-3">
                            <label class="form-label">Username</label>
                            <input class="form-control" type="text" placeholder="Username"  v-model="user.user_name">
                          </div>
                        </div>

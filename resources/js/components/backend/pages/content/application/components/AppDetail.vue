            ...
            <div class="col-auto">
                <fieldset class="mb-3">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check radio radio-primary">
                                <input class="form-check-input" disabled id="is_second_loan1" type="radio" value="yes" :selected="application.is_second_loan === 'yes'" v-model="application.is_second_loan">
                                <label class="form-check-label" for="is_second_loan1">Payof</label>
                            </div>
                            <div class="form-check radio radio-primary">
                                  <input class="form-check-input" disabled id="is_second_loan2" type="radio" value="no" :selected="application.is_second_loan === 'no'" v-model="application.is_second_loan">
